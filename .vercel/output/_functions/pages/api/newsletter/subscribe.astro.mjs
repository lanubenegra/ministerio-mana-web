...
import { c as containsBlockedSequence } from '../../../chunks/validation_DwYloAJB.mjs';
  ...
  if (rzKey) {
    await fetch("https://api.resend.com/emails", {
      ...
      body: JSON.stringify({
        ...
        html: lang === "es" ? "<p>Te enviaremos devocionales, eventos y oportunidades de apoyar la misión.</p>" : "<p>We will send devotionals, events and opportunities to support the mission.</p>"
      })
    });
  }
