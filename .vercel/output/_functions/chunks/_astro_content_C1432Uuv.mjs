...
import { A as AstroError, ak as UnknownContentCollectionError, c as createComponent, al as RenderUndefinedEntryError, ah as unescapeHTML, a as renderTemplate, am as renderUniqueStylesheet, an as renderScriptElement, ao as createHeadAndContent, r as renderComponent } from './astro/server_BHL5z7kF.mjs';
...
class ImmutableDataStore {
  ...
  static async fromModule() {
    try {
      const data = await import('./_astro_data-layer-content_Du-VWtuZ.mjs');
...
async function updateImageReferencesInBody(html, fileName) {
  ...
  const { getImage } = await import('./_astro_assets_B5m4ypWE.mjs').then(n => n._);
